...
public class RegModel {
 ...
 public String getName() {
  ...
  {
    String sql = "insert into regi(emailid ,name,mobileno,address,pincode,password) values('"+this.getEmailid()+"','"+
  ...
  {
    ResultSet rs = new DAO().queryReturner("select * from regi");
    return rs;
  }
  public boolean checkUser() throws Exception{
	  DAO obj = new DAO();
	  ResultSet rs= obj.queryReturner("select * from regi where emailid='"+this.getEmailid()+"' and password='"+this.getPassword()+"'");
	  if(rs.next()) {
